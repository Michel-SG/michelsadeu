...
export class DonneesService {
  articles: Array<Projet> = [
    ...
    },
    {
      ...
      trois: "Déployer des serveurs dans le cloud AWS",
      quatre: "Configurer et déployer une chaine d’intégration continue avec Jenkins et Gitlab-ci",
      cinq: "Déploiement d’une infrastructure dans le cloud AWS avec terraform, kubernetes",
      six: "Assurer l’administration des applications",
      sept: "Assurer les mises à jour et les évolutions techniques",
    },
    {
      id: 4,
